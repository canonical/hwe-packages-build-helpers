...
xa_unlocked:
	...
	if (result == SCAN_SUCCEED && !is_shmem &&
		 ...
		 * visible. Ensures the page cache will be truncated if the file
		 * is opened writable. If collapse looks to be successful, flush
		 * any dirty pages out the page cache. With the nr_thps incremented,
