...
static const struct dmi_system_id fwbug_list[] = {
	...
	/* Dell Pro Plus platforms with VR OVP quirk */
	{
		.ident = "DELL PRO 13 PLUS PB13255 (HPT1)",
		.driver_data = &quirk_vr_ovp,
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "Dell Inc"),
			DMI_EXACT_MATCH(DMI_PRODUCT_SKU, "0D47"),
		}
	},
	{
		.ident = "DELL PRO 13 PLUS PB13255 (HPT2)",
		.driver_data = &quirk_vr_ovp,
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "Dell Inc"),
			DMI_EXACT_MATCH(DMI_PRODUCT_SKU, "0D48"),
		}
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "Dell Inc"),
			DMI_EXACT_MATCH(DMI_PRODUCT_SKU, "0D4A"),
		}
	},
	{
		.ident = "DELL PRO 13 PLUS PB13255 360 (HPT2)",
		.driver_data = &quirk_vr_ovp,
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "Dell Inc"),
			DMI_EXACT_MATCH(DMI_PRODUCT_SKU, "0D4B"),
		}
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "Dell Inc"),
			DMI_EXACT_MATCH(DMI_PRODUCT_SKU, "0D5F"),
		}
	},
	{
		.ident = "DELL PRO 14 PLUS PB14255 (HPT2)",
		.driver_data = &quirk_vr_ovp,
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "Dell Inc"),
	...
	{
		.ident = "DELL PRO 14 PLUS PB14255 (HPT1 2-in-1)",
		.driver_data = &quirk_vr_ovp,
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "Dell Inc"),
			DMI_EXACT_MATCH(DMI_PRODUCT_SKU, "0D69"),
		}
	},
	{
		.ident = "DELL PRO 14 PLUS PB14255 (HPT2 2-in-1)",
		.driver_data = &quirk_vr_ovp,
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "Dell Inc"),
			DMI_EXACT_MATCH(DMI_PRODUCT_SKU, "0D6A"),
		}
	},
	{
		.ident = "DELL PRO 16 PLUS PB16255 (HPT1)",
		.driver_data = &quirk_vr_ovp,
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "Dell Inc"),
			DMI_EXACT_MATCH(DMI_PRODUCT_SKU, "0D4D"),
		}
	},
	{
		.ident = "DELL PRO 16 PLUS PB16255 (HPT2)",
		.driver_data = &quirk_vr_ovp,
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "Dell Inc"),
			DMI_EXACT_MATCH(DMI_PRODUCT_SKU, "0D4E"),
		}
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "Dell Inc"),
			DMI_EXACT_MATCH(DMI_PRODUCT_SKU, "0D50"),
		}
	},
	{
		.ident = "DELL PRO 14 PC14255 (HPT2)",
		.driver_data = &quirk_vr_ovp,
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "Dell Inc"),
			DMI_EXACT_MATCH(DMI_PRODUCT_SKU, "0D51"),
		}
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "Dell Inc"),
			DMI_EXACT_MATCH(DMI_PRODUCT_SKU, "0D53"),
		}
	},
	{
		.ident = "DELL PRO 16 PC16255 (HPT2)",
		.driver_data = &quirk_vr_ovp,
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "Dell Inc"),
